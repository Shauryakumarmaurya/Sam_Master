...
function LiveClock() {
  ...
  return (
    <span className="ml-3 inline-block border-l border-gray-300 pl-3 font-medium text-gray-600">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="flex items-center gap-2 rounded-lg border border-gray-200 bg-white px-4 py-2 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-50 hover:text-green-600"
            >
